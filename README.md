...
a Region Proposal Network (RPN) to localise potential regions before feeding them to the segmentation head. In this project I propose DetSeg, an architecture
